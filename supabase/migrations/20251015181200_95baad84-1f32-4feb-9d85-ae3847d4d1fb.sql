...
-- 2. Drop existing policies that need to be replaced
...
DROP POLICY IF EXISTS "Psychologists can view notes for their patients" ON public.notas;
DROP POLICY IF EXISTS "Psychologists can create notes for their patients" ON public.notas;
...
-- 3. Create new policies using security definer functions (prevents recursive queries)
